...
func TestFormatBytes_Zero(t *testing.T) {
	result := fsutil.FormatBytes(0)
	if result != "0 B" {
		t.Errorf("fsutil.FormatBytes(0) = %q, want %q", result, "0 B")
	}
}

func TestFormatBytes_OneByte(t *testing.T) {
	result := fsutil.FormatBytes(1)
	if result != "1 B" {
		t.Errorf("fsutil.FormatBytes(1) = %q, want %q", result, "1 B")
	}
}
...
func TestFormatBytes_Kilobyte(t *testing.T) {
	...
	if result != "1.0 KB" {
		t.Errorf("fsutil.FormatBytes(1024) = %q, want %q", result, "1.0 KB")
	}
}

func TestFormatBytes_Megabyte(t *testing.T) {
	result := fsutil.FormatBytes(1024 * 1024)
	if result != "1.0 MB" {
		t.Errorf("fsutil.FormatBytes(1048576) = %q, want %q", result, "1.0 MB")
	}
}

func TestFormatBytes_Gigabyte(t *testing.T) {
	result := fsutil.FormatBytes(1024 * 1024 * 1024)
	if result != "1.0 GB" {
		t.Errorf("fsutil.FormatBytes(1073741824) = %q, want %q", result, "1.0 GB")
	}
}

func TestFormatBytes_Terabyte(t *testing.T) {
	result := fsutil.FormatBytes(1024 * 1024 * 1024 * 1024)
	if result != "1.0 TB" {
		t.Errorf("fsutil.FormatBytes(1099511627776) = %q, want %q", result, "1.0 TB")
	}
}

func TestFormatBytes_LargeFile(t *testing.T) {
	result := fsutil.FormatBytes(500 * 1024 * 1024)
	if result != "500.0 MB" {
		t.Errorf("fsutil.FormatBytes(500MB) = %q, want %q", result, "500.0 MB")
	}
}
...
func TestFormatBytes_JustUnderKB(t *testing.T) {
	result := fsutil.FormatBytes(1023)
	if result != "1023 B" {
		t.Errorf("fsutil.FormatBytes(1023) = %q, want %q", result, "1023 B")
	}
}

func TestFormatBytes_JustOverKB(t *testing.T) {
	result := fsutil.FormatBytes(1025)
	if result != "1.0 KB" {
		t.Errorf("fsutil.FormatBytes(1025) = %q, want %q", result, "1.0 KB")
	}
}
